export const TRANSLATION_EN = {
  ...
  snappyCardBusinessTitle: 'Branch Offices',
  snappyCardBusinessContent: 'Effortlessly control multiple businesses. Experience unparalleled efficiency.',
  snappyCardProductTitle: 'Product Management',
  snappyCardProductContent: 'Complete product control: detailed info, alerts, categories.',
  snappyCardMaterialTitle: 'Material Management',
  snappyCardMaterialContent: 'User-controlled material management system for effective control.',
  snappyCardClientTitle: 'Client Management',
  snappyCardClientContent: 'Robust client management for efficient system operation.',
  snappyCardInvoicingTitle: 'Invoicing & Taxes',
  snappyCardInvoicingContent: 'Invoice and tax management for seamless sales/purchases.',
  snappyCardSalesTitle: 'Sales & Inventory',
  snappyCardSalesContent: 'Streamlined operations: sales, purchases, and inventory.',
  snappyCardLearnMore: 'Learn more ',

  snappyServiceDescriptionBranchOffices: 'Business & Branch Offices',
  ...
  snappyServiceDescriptionProductManagement: 'Product Management',
  ...
  snappyServiceDescriptionMaterialManagement: 'Material Management',
  ...
  snappyServiceDescriptionClientManagement: 'Client Management',
  ...
  snappyServiceDescriptionInvoicing: 'Invoicing & Tax Management',
  ...
  snappyServiceDescriptionSales: 'Sales, Purchases & Inventory Management',
